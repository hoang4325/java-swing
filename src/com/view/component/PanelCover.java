...
import com.view.swing.ButtonOutLine;
    ...
    public void login(boolean login) {
        if (this.isLogin != login) {
            if (login) {
                ...
                description.setText("Nhập thông tin vào đây");
                description1.setText("để đồng hành cùng chúng tôi nhé!");
                button.setText("SIGN UP");
            } else {
                title.setText("Chào mừng bạn đã trở lại!");
                description.setText("Hãy tiếp tục đồng hành cùng chúng tôi");
